...
const CheckoutDetails = () => {
    ...
    const handleOrderSubmit = async () => {
        if (validateForm()) {
            ...
            try {
                const response = await axios.post('https://blissfulpk-server.vercel.app/api/place-order', orderData);
    ...
    const handleSubscribe = async (e) => {
        ...
        try {
            const response = await axios.post('https://blissfulpk-server.vercel.app/api/subscribe', { email: contactInfo.email });
